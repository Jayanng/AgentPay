#!/usr/bin/env node
/**
 * AgentPay CLI — Agent-Native Payment agent.
 *
 *   agentpay                       Interactive mode
 *   agentpay "buy weather API"     One-shot mode
 *   agentpay --help                Show help
 */
...
async function main() {
  ...
  if (args.includes("--help") || args.includes("-h")) {
    console.log(`
  \x1b[1mAgentPay\x1b[0m — Agent-Native Payment agent

  \x1b[2mUsage:\x1b[0m
    agentpay                           Interactive mode
    agentpay "buy me weather API"      One-shot mode
