...
describe("getChainMetadata", () => {
  ...
  it("should return correct Sepolia metadata", () => {
    const meta = getChainMetadata("sepolia");
    expect(meta.chainId).toBe(11155111);
    expect(meta.isTestnet).toBe(true);
    expect(meta.nativeToken.symbol).toBe("ETH");
    expect(meta.defaultPaymentToken).toBe("ETH");
  });
...
describe("getViemChain", () => {
  ...
  it("should return viem chain for Sepolia", () => {
    const chain = getViemChain("sepolia");
...
describe("getTokenDecimals", () => {
  it("should return 18 for native tokens", () => {
    ...
    expect(getTokenDecimals("sepolia", "ETH")).toBe(18);
  });
...
describe("getTokenAddress", () => {
  ...
  it("should return Sepolia USDC address", () => {
    const addr = getTokenAddress("sepolia", "USDC");
...
describe("getAvailableTokens", () => {
  ...
  it("should include ETH for Sepolia", () => {
...
describe("getNetworkByChainId", () => {
  it("should find network by chain ID", () => {
    ...
    expect(getNetworkByChainId(11155111)).toBe("sepolia");
  });
