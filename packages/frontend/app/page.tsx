        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="group p-8 rounded-3xl bg-card border border-border hover:border-primary/30 transition-all duration-300 glow-border relative">
              ...
              <p className="text-muted-foreground leading-relaxed">Paywall your APIs, files, and articles with agent-native payments via x402.</p>
            </div>
            ...
            <div className="group p-8 rounded-3xl bg-card border border-border hover:border-primary/30 transition-all duration-300 glow-border relative">
              ...
              <p className="text-muted-foreground leading-relaxed">Share your unique AgentPay link. Anyone — humans or AI agents — can pay and access.</p>
            </div>
      ...
      <section className="py-24 px-6" id="features">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            {/* Cobo Agentic Wallet — full width */}
            <div className="group p-8 md:p-10 rounded-3xl bg-card border border-border hover:border-sp-blue/30 transition-all duration-300 glow-border md:col-span-2">
              <div className="flex flex-col md:flex-row md:items-center gap-8">
                <div className="flex-1">
                  <div className="size-14 rounded-2xl bg-sp-blue/15 text-sp-blue flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
                    <Shield className="h-7 w-7" />
                  </div>
                  <h3 className="text-3xl font-bold mb-3">Cobo Agentic Wallet</h3>
                  <p className="text-muted-foreground leading-relaxed text-lg">
                    Every agent payment routes through CAW with permission policies — spending limits, chain/token whitelists, and destination restrictions. Agents pay autonomously, safely.
                  </p>
                </div>
                <div className="flex-shrink-0 bg-secondary rounded-2xl p-6 space-y-3 min-w-[280px]">
                  <div className="flex items-center justify-between text-sm">
                    ...
                    <span className="font-bold text-sp-blue">✓ Enforced</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-muted-foreground">Token Whitelist</span>
                    <span className="font-bold text-sp-pink">✓ USDC Only</span>
                  </div>
                  <div className="flex items-center justify-between text-sm">
                    <span className="text-muted-foreground">Dest Restriction</span>
                    <span className="font-bold text-sp-gold">✓ Active</span>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <div className="p-8 rounded-3xl bg-card border border-border glow-border relative flex flex-col">
              ...
              <p className="text-foreground leading-relaxed flex-1">
                &ldquo;Moved my paid newsletter off Substack and onto AgentPay. My readers pay 50 cents per article in USDC. I keep 100%. No platform fees eating my margins.&rdquo;
              </p>
              <div className="flex items-center gap-3 mt-6 pt-6 border-t border-border">
            ...
            <div className="p-8 rounded-3xl bg-card border border-border glow-border relative flex flex-col">
              ...
              <p className="text-foreground leading-relaxed flex-1">
                &ldquo;We monetize our AI API through AgentPay. Agents discover and pay for access automatically — CAW handles all the permission and payment logic. Revenue grew 10x after adding x402 support.&rdquo;
              </p>
              <div className="flex items-center gap-3 mt-6 pt-6 border-t border-border">
        ...
        <div className="relative max-w-3xl mx-auto text-center space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4">
            {isAuthenticated ? (
              ...
              >
                Create Your First AgentPay <ArrowRight className="h-5 w-5" />
              </Link>
            ) : (
              <WalletConnect />
            )}
      ...
      <footer className="py-16 px-6 border-t border-border">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="pt-8 border-t border-border flex flex-col md:flex-row items-center justify-between gap-4">
            <p className="text-muted-foreground text-sm">&copy; 2025 AgentPay. All rights reserved.</p>
