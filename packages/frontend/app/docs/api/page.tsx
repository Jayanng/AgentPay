...
{`{
  ...
  "isPublic": true
          ...
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="text-foreground text-2xl">x402 Resource Access</CardTitle>
              <CardDescription className="text-muted-foreground">
                Access paid resources via the x402 protocol
              </CardDescription>
            </CardHeader>
            <CardContent className="space-y-6">
              <div className="border-l-4 border-primary pl-4">
                ...
                <p className="text-muted-foreground">List all public resources</p>
              </div>
              ...
              <div className="border-l-4 border-primary pl-4">
                ...
                <p className="text-muted-foreground mb-3">Access a resource (HTTP 402 enabled)</p>
                <p className="text-sm text-muted-foreground mb-2">Payment Header:</p>
                <pre className="bg-muted p-4 rounded-xl overflow-x-auto text-sm border border-border text-foreground">
{`X-PAYMENT: {
  "transactionHash": "0x...",
