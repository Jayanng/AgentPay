    ...
    <div className="flex flex-col gap-12">
      <section>
        <div className="flex flex-col gap-4">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl">
            Complete reference for all AI agent skills. Agents can discover, purchase, and access digital resources using USDC payments.
          </p>
        </div>
      </section>
      ...
      <section className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <Card className="bg-card border-border">
            <CardHeader className="pb-2">
              <CardTitle className="text-base font-mono text-primary">x402_list_agent_services</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">List all available x402-enabled agent services</p>
            </CardContent>
          </Card>

          <Card className="bg-card border-border">
            <CardHeader className="pb-2">
              <CardTitle className="text-base font-mono text-primary">x402_browse_services</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">Browse agent services with filters and search</p>
            </CardContent>
          </Card>
        </div>
    ...
    "resources": [...]
          ...
          <CardContent className="space-y-4">
            ...
            <div className="text-sm space-y-1">
              ...
              <ul className="list-disc list-inside text-muted-foreground space-y-1">
                <li><code className="bg-muted px-1 rounded">type</code> &mdash; Filter by type: <code className="bg-muted px-1 rounded">api</code>, <code className="bg-muted px-1 rounded">file</code>, <code className="bg-muted px-1 rounded">article</code>, <code className="bg-muted px-1 rounded">agent</code></li>
      ...
      <section className="flex flex-col gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <Card className="bg-card border-border">
            <CardHeader className="pb-2">
              <CardTitle className="text-base font-mono text-primary">x402_pay_for_access</CardTitle>
            </CardHeader>
            <CardContent>
              <p className="text-sm text-muted-foreground">Pay for access to a resource: auto-pay USDC on-chain and retrieve content</p>
            </CardContent>
          </Card>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm">
            ...
            <tbody className="text-muted-foreground">
              ...
              <tr>
                <td className="py-3 pr-4"><code className="bg-muted px-2 py-0.5 rounded text-primary">agent</code></td>
                <td className="py-3 pr-4">AI agent services &mdash; pay-per-task, tool access</td>
                <td className="py-3">$0.01 &mdash; $5.00</td>
              </tr>
            </tbody>
          </table>
        </div>
