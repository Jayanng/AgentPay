...
export const metadata: Metadata = {
  title: "AgentPay — Agent-Native Payments on the Internet",
  description: "Paywall your APIs, files, and articles with USDC. AI-agent ready payments powered by HTTP 402 and Cobo Agentic Wallet.",
  icons: {
    icon: [
