...
const typeColors: Record<string, { bg: string; text: string; border: string; btn: string; btnHover: string; shadow: string }> = {
  ...
  agent: { bg: "from-sp-blue/20 to-sp-blue/10", text: "text-sp-blue", border: "border-sp-blue/40", btn: "bg-sp-blue", btnHover: "hover:bg-sp-blue/90", shadow: "shadow-sp-blue/10" },
};
          ...
          <div className="max-w-3xl mx-auto w-full flex flex-col items-center gap-8">
            <div className="text-center">
              ...
              <p className="text-muted-foreground">
                Explore curated resources and expert creators
              </p>
            </div>
        ...
        <section className="flex flex-col gap-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            ...
            <div className="flex bg-card p-1.5 rounded-2xl border border-border w-fit overflow-x-auto hide-scroll">
              ...
              {["api", "file", "article", "agent"].map((type) => (
                <button
                  key={type}
                          ...
                          onClick={() => {
                            setPurchaseItem({
                              ...
                              data: {
                                id: resource.id,
                                slug: resource.slug,
                                type: resource.type as "api" | "file" | "article" | "agent",
                                name: resource.name,
