...
export type TokenSymbol = "ETH" | "USDC" | "USDT" | "DAI" | "CRO" | "MNT";

export type NativeTokenSymbol = "ETH" | "CRO" | "MNT";
...
export const CHAIN_REGISTRY: Record<NetworkId, ChainMetadata> = {
  ...
  mainnet: {
    ...
    tokens: {
      ...
      DAI: { address: "0x6B175474E89094C44Da98b954EedeCB5BE2AE36", decimals: 18 },
    },
...
export function isNativeToken(symbol: TokenSymbol): symbol is NativeTokenSymbol {
  return ["ETH", "CRO", "MNT"].includes(symbol);
}
