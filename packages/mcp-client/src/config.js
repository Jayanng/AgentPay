...
export const CAW_API_KEY = process.env.CAW_API_KEY;
export const CAW_WALLET_ID = process.env.CAW_WALLET_ID;
export const CAW_API_URL = process.env.CAW_API_URL || "https://api.agenticwallet.cobo.com";
export const CAW_CHAIN_ID = process.env.CAW_CHAIN_ID; // e.g., "SETH" for Sepolia
export const CAW_TOKEN_ID = process.env.CAW_TOKEN_ID; // e.g., "SETH_USDC" for Sepolia USDC
export const IS_CAW_MODE = !!(CAW_API_KEY && CAW_WALLET_ID);
...
export const NETWORK = process.env.X402_CHAIN || process.env.ETH_NETWORK || "sepolia";
...
export const CHAINS = {
  ...
  sepolia: sepolia,
  base: base,
  "base-sepolia": baseSepolia,  // Kept for backward compat; default is Ethereum Sepolia
  polygon: polygon,
...
export const TOKEN_ADDRESSES = {
  ...
  "base-sepolia": {
    USDC: "0xa059e27967e5a573a14a62c706ebd1be75333f9a",  // Kept for backward compat
  },
  polygon: {
